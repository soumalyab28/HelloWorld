...
import time
# define our clear function - for clearing board
def clear():
    if name == 'nt':
        _ = system('cls')
...
#Step 3: Run the place marker function using test parameters and display the modified board
# place_marker(test_board,'$',8)
# display_board(test_board)


#Step 4: Write a function that takes in a board and checks to see if someone has won. 
# All possibilities must be covered - horizontal, vertical and diagonal.
...
while True:
    ...
    play_game = input('Are you ready to play? Enter Yes or No(Y/N) : ')
